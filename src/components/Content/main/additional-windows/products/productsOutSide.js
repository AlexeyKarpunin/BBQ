...
const kebab = {
    ...
    products: [
        {
            imgLink: '../../../../img/kebab-img/kebab8.jpg',
            name: 'Картофель',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/kebab-img/kebab9.jpg',
            name: 'Крылья',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/kebab-img/kebab10.jpg',
            name: 'Филе курицы',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/kebab-img/kebab11.jpg',
            name: 'Овощи',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/kebab-img/kebab12.jpg',
            name: 'Грибы',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/kebab-img/kebab13.jpeg',
            name: 'Ханский',
            description: ' ',
            dose: '100' ,
            calculation: 'гр',
...
const lulaKebab = {
    ...
    products: [
        {
            imgLink: '../../../../img/lula-kebab/lula-kebab1.jpg',
            name: 'Картофель',
            description: '',
            dose: '100 ' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/lula-kebab/lula-kebab2.jpg',
            name: 'Курица',
            description: '',
            dose: '100 ' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/lula-kebab/lula-kebab3.jpg',
            name: 'Говядина',
            description: '',
            dose: '100 ' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/lula-kebab/lula-kebab4.jpg',
            name: 'Свенина',
            description: '',
            dose: '100 ' ,
            calculation: 'гр',
        ...
        {
            imgLink: '../../../../img/lula-kebab/lula-kebab5.jpg',
            name: 'Баранина',
            description: '',
            dose: '100 ' ,
            calculation: 'гр',
...
const productsOutSideArr = [kebab, lulaKebab]; // last index = 4
